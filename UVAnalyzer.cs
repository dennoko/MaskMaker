...
namespace Dennoko.UVTools
{
    ...
    public static class UVAnalyzer
    {
        ...
        /// <summary>
        /// Analyze the mesh UVs (channel 0) to compute islands and border edges (seams).
        /// </summary>
        public static UVAnalysis Analyze(Mesh mesh)
        {
            ...
            mesh.GetUVs(0, uvs);
            if (uvs == null || uvs.Count == 0) throw new InvalidOperationException("Mesh has no UV0.");
